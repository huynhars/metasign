...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    // Biến điều khiển ẩn/hiện Sidebar trên Tablet/Mobile
    ...
    // Phương thức bật/tắt Sidebar
    toggleSidebar(): void {
        this.isSidebarOpen = !this.isSidebarOpen;
    }

    // Phương thức đóng Sidebar (thường dùng khi click backdrop hoặc chuyển trang)
    closeSidebar(): void {
